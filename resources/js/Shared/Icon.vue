<template>
  ...
  <svg v-else-if="name === 'login'" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M20.5,1.5h-17c-1.378,0-2.5,1.122-2.5,2.5v16c0,1.378,1.122,2.5,2.5,2.5h17c1.378,0,2.5-1.122,2.5-2.5v-16C23,2.622,21.878,1.5,20.5,1.5z M21,19.5c0,0.276-0.224,0.5-0.5,0.5h-17c-0.276,0-0.5-0.224-0.5-0.5v-16c0-0.276,0.224-0.5,0.5-0.5h17c0.276,0,0.5,0.224,0.5,0.5V19.5z M15.793,10.793c0.391,0.391,0.391,1.023,0,1.414l-3.793,3.793c-0.195,0.195-0.451,0.293-0.707,0.293s-0.512-0.098-0.707-0.293l-3.793-3.793c-0.391-0.391-0.391-1.023,0-1.414s1.023-0.391,1.414,0l2.793,2.793V5.5c0-0.553,0.448-1,1-1s1,0.447,1,1V10.793z"/>
</svg>
